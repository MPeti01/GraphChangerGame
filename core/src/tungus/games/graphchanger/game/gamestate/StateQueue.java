...
class StateQueue {
    ...
    public StateQueue(GraphLoader loader, MoveListener listener, Player player, int size) {
        this.size = size;
        ...
        for (int i = 0; i < this.size; i++)
        {
            ...
            GraphEditingUI editor = new GraphEditingUI(g, player, listener);
            Army a1 = new Army(Player.P1);
            Army a2 = new Army(Player.P2);
            queue[i] = new GameState(g, editor, a1, a2);
        }
    }
